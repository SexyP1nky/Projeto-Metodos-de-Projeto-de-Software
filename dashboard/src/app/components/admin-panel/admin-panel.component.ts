...
export class AdminPanelComponent {
  ...
  users: User[] = [
    new User('John Doe', '257854309314592768', new Date('2025-02-23T14:45:00Z'), false),
    new User('Jane Smith', '311968496466526208', new Date('2025-02-22T08:30:00Z'), false,),
    new User('Sam Green', '656706124560728065', new Date('2025-02-20T19:15:00Z'), true)
  ];
